% fname: dimXY_8x8__routing_ODD_EVEN__topology_MESH__.m
% ../bin/noxim  -routing ODD_EVEN -topology MESH -dimx 8 -dimy 8  -sim 100000 -warmup 2000 -size 8 8 -buffer 4 -config ../configs/mcsl_default.yaml -power ../bin/power.yaml 

function [max_pir, max_throughput, min_delay] = dimXY_8x8__routing_ODD_EVEN__topology_MESH__(symbol)

data = [
%             pir      avg_delay     throughput      max_delay   total_energy       rpackets         rflits
             0.01        9.41533      0.0291802            270    8.07868e-05          22878         183018
             0.04        2744.16      0.0734416          33224    8.35946e-05          57581         460626
];
