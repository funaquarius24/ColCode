% fname: dimXY_8x8__routing_DELTA__topology_MESH__.m
% ../bin/noxim  -routing DELTA -topology MESH -dimx 8 -dimy 8  -sim 100000 -warmup 2000 -size 8 8 -buffer 4 -config ../configs/mcsl_default.yaml -power ../bin/power.yaml 

function [max_pir, max_throughput, min_delay] = dimXY_8x8__routing_DELTA__topology_MESH__(symbol)

data = [
%             pir      avg_delay     throughput      max_delay   total_energy       rpackets         rflits
             0.01        3.71474     0.00969388             50    7.94134e-05           7600          60800
             0.04        12.0473      0.0173023            198    7.96171e-05          13565         108520
];
