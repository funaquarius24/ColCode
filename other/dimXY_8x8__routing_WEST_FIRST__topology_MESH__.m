% fname: dimXY_8x8__routing_WEST_FIRST__topology_MESH__.m
% ../bin/noxim  -routing WEST_FIRST -topology MESH -dimx 8 -dimy 8  -sim 100000 -warmup 2000 -size 8 8 -buffer 4 -config ../configs/mcsl_default.yaml -power ../bin/power.yaml 

function [max_pir, max_throughput, min_delay] = dimXY_8x8__routing_WEST_FIRST__topology_MESH__(symbol)

data = [
%             pir      avg_delay     throughput      max_delay   total_energy       rpackets         rflits
             0.01        9.31312      0.0296311            123    8.07987e-05          23234         185846
             0.04        2125.76      0.0750748          50398    8.36501e-05          58861         470869
];
