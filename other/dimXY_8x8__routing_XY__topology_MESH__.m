% fname: dimXY_8x8__routing_XY__topology_MESH__.m
% ../bin/noxim  -routing XY -topology MESH -dimx 8 -dimy 8  -sim 100000 -warmup 2000 -size 8 8 -buffer 4 -config ../configs/mcsl_default.yaml -power ../bin/power.yaml 

function [max_pir, max_throughput, min_delay] = dimXY_8x8__routing_XY__topology_MESH__(symbol)

data = [
%             pir      avg_delay     throughput      max_delay   total_energy       rpackets         rflits
             0.01         9.0344      0.0291462            138    8.06965e-05          22851         182805
             0.04        1951.64      0.0748304          59415     8.3611e-05          58669         469336
];
